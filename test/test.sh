...
echo "=> $cm1"
if diff <(echo "approx 0 test" | ref/TextMiningApp ref/dict.bin 2> /dev/null) <(echo "approx 0 test" | ./TextMiningApp dict.bin 2> /dev/null) > /dev/null
then
    test_done=$((test_done + 1))
    echo "[OK]"
else
...
echo "=> $cm1"
if diff <(echo "approx 1 test" | ref/TextMiningApp ref/dict.bin 2> /dev/null) <(echo "approx 1 test" | ./TextMiningApp dict.bin 2> /dev/null) > /dev/null
then
    test_done=$((test_done + 1))
    echo "[OK]"
else
...
echo "=> $cm1"
if diff <(echo "approx 2 test" | ref/TextMiningApp ref/dict.bin 2> /dev/null) <(echo "approx 2 test" | ./TextMiningApp dict.bin 2> /dev/null) > /dev/null
then
    test_done=$((test_done + 1))
    echo "[OK]"
else
...
echo "=> $cm1"
if diff <(echo "approx 3 test" | ref/TextMiningApp ref/dict.bin 2> /dev/null) <(echo "approx 3 test" | ./TextMiningApp dict.bin 2> /dev/null) > /dev/null
then
    test_done=$((test_done + 1))
    echo "[OK]"
else
...
echo "=> $cm1"
if diff <(echo "approx 4 test" | ref/TextMiningApp ref/dict.bin 2> /dev/null) <(echo "approx 4 test" | ./TextMiningApp dict.bin 2> /dev/null) > /dev/null
then
    test_done=$((test_done + 1))
    echo "[OK]"
else
